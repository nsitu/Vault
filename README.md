# Vault
[![Open in Coder](https://ixdcoder.com/open-in-coder.svg)](https://ixdcoder.com/templates/Node/workspace?name=Vault&mode=auto&param.git_repo=https://bender.sheridanc.on.ca/system-design/vault&param.code_template=custom)
